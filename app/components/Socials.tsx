...
export function Socials() {
  ...
  return (
      ...
      >
        ...
        <button onClick={()=>router.push("/projects")} className="2xl:w-1/3 flex justify-between p-4 text-black bg-[#A08C5B] hover:text-[#A08C5B] backdrop-blur-sm border border-black hover:bg-black rounded-md hover:shadow-[0px_0px_4px_4px_rgba(212,175,55,0.5)] text-sm transition duration-400">
