...
export function Socials() {
  ...
  return (
      <motion.div
        ...
        className={`2xl:py-32 lg:py-44 lg:mt-24 flex h-full max-w-full ml-10 px-10 ${!isDesktop && 'socials'}`}
      >
        ...
        <h1 className={`text-3xl font-bold md:text-4xl ${!isDesktop && 'pr-7'}`}>Top notch <Highlight className="text-white dark:text-white"> projects </Highlight>  with a perfect mix of....</h1>
           </div>
        ...
        <button onClick={()=>router.push("/projects")} className={`${!isDesktop && 'w-full'} 2xl:w-1/3 lg:w-1/2 flex justify-between p-4 text-black bg-[#A08C5B] hover:text-[#A08C5B] backdrop-blur-sm border border-black hover:bg-black rounded-md hover:shadow-[0px_0px_4px_4px_rgba(212,175,55,0.5)] text-sm transition duration-400`}>
