...
const SelectedCard = ({ selected }: { selected: Card | null; onClick: () => void }) => {
  ...
  return (
    <div className={`bg-transparent h-full w-full flex px-20 flex-col justify-center rounded-lg shadow-2xl relative z-[60] ${!isDesktop && 'w-full px-0 h-full ml-[-40px]'}`}>
      <motion.div
        initial={{
          opacity: 0,
        }}
